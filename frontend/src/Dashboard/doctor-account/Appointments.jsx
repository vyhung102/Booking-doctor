    ...
    <tbody>
        {appointments?.map(item => <tr key={item._id}>
            ...
            <td className="px-6 py-4 ">
                {item.isPaid && (
                <div className="flex items-center"><div className="h-2 w-2.5 rounded-full bg-green-500 mr-2"></div>
                Paid
                </div>
                )}

                {!item.isPaid && (
                <div className="flex items-center"><div className="h-2 w-2.5 rounded-full bg-red-500 mr-2"></div>
                Unpaid
                </div>
                )}
            </td>
