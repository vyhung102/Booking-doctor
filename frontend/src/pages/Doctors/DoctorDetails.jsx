            ...
            <div className='flex items-center gap-5'>
              ...
              <div>
                ...
                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>
                  Munhibur nổi bật bởi khả năng giải quyết vấn đề một cách sáng tạo và kỹ năng quản lý dự án xuất sắc. Anh ấy không chỉ hoàn thành nhiệm vụ của mình một cách xuất sắc mà còn hỗ trợ đồng nghiệp vượt qua các thách thức.
                </p>
              </div>
            </div>
